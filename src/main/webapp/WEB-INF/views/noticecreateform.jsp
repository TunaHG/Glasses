						...
						<form action="<%=request.getContextPath()%>/boardinsert" method="post">
							<table class="createboard">
								<tr>
									...
									<td class="createboard" colspan="2"><input type=text name="title"></td>
								</tr>
								<tr>
									<td class="createboard">내용</td>
									<td class="createboard" colspan="2"><textarea rows="10" cols="100" name="contents"></textarea></td>
								</tr>
								<tr>
									<td>
										<input type=hidden value="<%=vo.getMember_id()%>" name="member_id">
