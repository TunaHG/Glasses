			...
			<div class="container-fluid">
				...
				<div class="card mb-4">
					<div class="card-header">
						<i class="fas fa-table mr-1"></i>게시물 수정
					</div>
					<div class="card-body">
								...
								<table class="createboard">
									...
									<tr>
										...
										<td class="createboard" colspan="2"><textarea rows="10"
												cols="100" name="contents">${update.contents}</textarea></td>
									</tr>
									<tr>
										<td><input type=hidden value="${update.board_no}"
											name="board_no"> <input type=hidden value="free"
											name="form"> <input type=submit value="수정완료">
										</td>
										<td></td>
										<td></td>
								</table>
