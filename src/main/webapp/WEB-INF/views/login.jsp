                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">아이디</label><input class="form-control py-4" id="inputEmailAddress" type="email" placeholder="아이디" /></div>
                                            ...
                                            <div class="form-group mt-4 mb-0"><a class="btn btn-gray btn-block" href="login.html">로그인</a></div>
                                        </form>
                                    </div>
                                    <div class="card-footer text-center">
                                        <a href="register.html" class="badge-light"><div class="small">아이디가 없으신가요? <span>&nbsp;</span> 회원가입</div></a>
                                    </div>
                                </div>
                            </div>
                        </div>
